  ...
  },
  {
    ...
    token: {
      ...
      coinGeckoData: {
        ...
        description: "Solana AI is a decentralized artificial intelligence platform built on Solana.",
...
export async function GET() {
  try {
    ...
    try {
      ...
      const rawText = await response.text().catch(() => 'Could not get response text');
