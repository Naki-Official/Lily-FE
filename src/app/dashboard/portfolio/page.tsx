      ...
      <div className='mx-auto max-w-7xl px-6 py-8'>
        ...
        <div className='grid grid-cols-1 gap-8 lg:grid-cols-3'>
          ...
          <div className='col-span-2 space-y-8'>
            ...
            <div className='grid grid-cols-1 gap-6 md:grid-cols-2'>
              <div className='rounded-xl bg-[#F9F9F9] p-6 shadow-sm'>
                <h3 className='font-sf-pro-rounded text-lg font-semibold text-[#162D3A]'>
                  Total Value
                </h3>
                <p className='font-sf-pro-rounded text-2xl font-semibold text-[#162D3A] mt-2'>
                  3,500 SOL
                </p>
                <div className='mt-2 flex items-center text-sm text-[#34C759]'>
                  ...
                  >
                    <path
                      d='M8 3.33334V12.6667M8 3.33334L4 7.33334M8 3.33334L12 7.33334'
                      stroke='#34C759'
                      strokeWidth='1.5'
                      strokeLinecap='round'
                ...
                <div className='relative w-64 h-64'>
                  ...
                  <div className='absolute inset-0 flex items-center justify-center'>
                    <div className='text-center'>
                      ...
                      <p className='font-sf-pro text-lg font-semibold'>
                        2000 SOL
                      </p>
                    </div>
                  </div>
                  ...
                  {[
                    ...
                    return (
                      <tr key={index} className='border-b border-[#CECECE]'>
                        <td className='py-4 font-sf-pro text-sm font-medium text-[#292D32]'>
                          {tokenData.name}
                        </td>
                        <td className='py-4 font-sf-pro text-sm text-[#292D32]'>
                          {item.amount}
                        </td>
                        <td className='py-4 font-sf-pro text-sm text-[#292D32]'>
                          {item.value} SOL
                        </td>
                        <td className='py-4 font-sf-pro text-sm text-[#149D52]'>
                          {item.change}
                        </td>
                        <td className='py-4'>
                          <div className='flex space-x-2'>
                            <button className='rounded bg-[#59CD30] px-3 py-1 text-xs text-white'>
                              Buy
                            </button>
                            <button className='rounded bg-[#FC0000] px-3 py-1 text-xs text-white'>
                              Sell
                            </button>
                          </div>
                        </td>
            ...
            <div className='rounded-3xl bg-white p-8 shadow-sm'>
              <h3 className='mb-6 font-sf-pro text-sm font-medium text-[#162D3A]'>
                Portfolio Value Over Time
              </h3>
                ...
                <table className='w-full'>
                  <thead>
                    <tr className='border-b border-[#000000]'>
                      <th className='pb-4 text-left font-sf-pro text-sm font-medium text-[#162D3A]'>
                        Asset
                      </th>
                      <th className='pb-4 text-left font-sf-pro text-sm font-medium text-[#162D3A]'>
                        Amount
          ...
          <div className='space-y-8'>
            ...
            <div className='rounded-3xl bg-white p-8 shadow-sm'>
              <h3 className='mb-4 font-sf-pro text-sm font-medium text-[#162D3A]'>
                Lily's Recommendations
              </h3>
              ...
              <div className='space-y-6'>
                <div className='border-b border-[#DBE5EB] pb-6 opacity-80'>
                  <div className='flex items-center space-x-3'>
                    ...
                    <p className='font-sf-pro text-sm font-medium text-[#273240]'>
                      "Buy 10% more BTC"
                    </p>
                  </div>
                </div>
            ...
            <div className='rounded-3xl bg-white p-8 shadow-sm'>
              ...
              <div className='space-y-6'>
                <div className='border-b border-[#DBE5EB] pb-6 opacity-80'>
                  <div className='flex items-center justify-between'>
                    <p className='font-sf-pro text-xs text-[#273240]'>
                      12:09:22
                    </p>
                    <p className='font-sf-pro text-xs text-[#273240]'>
                      Nov 2nd, 2024
