      ...
      <div className="mx-auto max-w-7xl px-6 py-8">
        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          ...
          <div className="col-span-2 space-y-8">
            ...
            <div className="rounded-3xl bg-white p-8 shadow-sm">
              ...
              <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
                <div className="space-y-6">
                  <div>
                    <label className="mb-2 block font-sf-pro text-sm font-medium text-[#8A8A8E]">Select Token</label>
                    <div className="relative">
                      ...
                      <div className="pointer-events-none absolute inset-y-0 right-0 flex items-center px-4">
                        <svg width="12" height="8" viewBox="0 0 12 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path d="M1 1.5L6 6.5L11 1.5" stroke="#8A8A8E" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                        </svg>
                      </div>
                    </div>
                  </div>
                  <div>
                    <label className="mb-2 block font-sf-pro text-sm font-medium text-[#8A8A8E]">Amount</label>
                    <input 
                      type="text" 
                  ...
                  <div>
                    <label className="mb-2 block font-sf-pro text-sm font-medium text-[#8A8A8E]">Price (USD)</label>
                    <input 
                      type="text" 
                ...
                <div className="space-y-6">
                  <div>
                    <label className="mb-2 block font-sf-pro text-sm font-medium text-[#8A8A8E]">Total (USD)</label>
                    <input 
                      type="text" 
                      className="w-full rounded-xl border border-[#E5E5EA] bg-[#F9F9F9] p-4 font-sf-pro text-[#8A8A8E] focus:outline-none" 
                      placeholder="$0.00"
                  ...
                  <div className="pt-8">
                    <button className={`w-full rounded-xl p-4 text-center font-sf-pro text-base font-semibold text-white shadow-sm ${buyOrSell === 'buy' ? 'bg-[#34C759]' : 'bg-[#FF3B30]'}`}>
            ...
            {/* Market data */}
            <div className="rounded-3xl bg-white p-8 shadow-sm">
              <h3 className="mb-6 font-sf-pro-rounded text-xl font-semibold text-[#162D3A]">Market Data</h3>
              <div className="overflow-x-auto">
                <table className="w-full">
                  <thead>
                    <tr className="border-b border-[#E5E5EA]">
                      <th className="pb-4 text-left font-sf-pro text-sm font-medium text-[#8A8A8E]">Token</th>
                      <th className="pb-4 text-left font-sf-pro text-sm font-medium text-[#8A8A8E]">Price (USD)</th>
                      <th className="pb-4 text-left font-sf-pro text-sm font-medium text-[#8A8A8E]">24h Change</th>
                      <th className="pb-4 text-left font-sf-pro text-sm font-medium text-[#8A8A8E]">7d Change</th>
                      <th className="pb-4 text-left font-sf-pro text-sm font-medium text-[#8A8A8E]">Market Cap</th>
                      <th className="pb-4 text-left font-sf-pro text-sm font-medium text-[#8A8A8E]">Action</th>
                    </tr>
                  </thead>
                  <tbody>
                    {[
                      ...
                      <tr key={index} className="border-b border-[#F2F2F7]">
                        ...
                        <td className={`py-4 font-sf-pro ${item.day.startsWith('+') ? 'text-[#34C759]' : 'text-[#FF3B30]'}`}>{item.day}</td>
                        <td className={`py-4 font-sf-pro ${item.week.startsWith('+') ? 'text-[#34C759]' : 'text-[#FF3B30]'}`}>{item.week}</td>
                        <td className="py-4 font-sf-pro text-[#162D3A]">{item.cap}</td>
                        <td className="py-4">
          ...
          <div className="space-y-8">
            ...
            <div className="rounded-3xl bg-white p-8 shadow-sm">
              <div className="flex items-center space-x-3 mb-6">
                ...
                <h3 className="font-sf-pro-rounded text-xl font-semibold text-[#162D3A]">Lily's Recommendations</h3>
              </div>
              ...
              <div className="space-y-4">
                <div className="rounded-xl border border-[#E5E5EA] p-4">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <p className="font-sf-pro font-medium text-[#162D3A]">"Buy 0.05 BTC now"</p>
                      <p className="font-sf-pro text-sm text-[#8A8A8E]">Price is expected to rise 5% in 24h</p>
                    </div>
                  </div>
                </div>
                <div className="rounded-xl border border-[#E5E5EA] p-4">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <p className="font-sf-pro font-medium text-[#162D3A]">"Set alert if ETH &lt; $2,300"</p>
                      <p className="font-sf-pro text-sm text-[#8A8A8E]">Good buying opportunity if price drops</p>
                    </div>
                  </div>
                </div>
                <div className="rounded-xl border border-[#E5E5EA] p-4">
                  <div className="flex items-center space-x-3">
                    <div className="h-10 w-10 rounded-full bg-[#00FFA3] flex items-center justify-center">
                      <span className="font-sf-pro text-sm font-bold text-[#162D3A]">SOL</span>
                    </div>
                    <div>
                      <p className="font-sf-pro font-medium text-[#162D3A]">"Hold SOL for now"</p>
                      <p className="font-sf-pro text-sm text-[#8A8A8E]">Market is stabilizing after recent gains</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            {/* Recent Activity */}
            <div className="rounded-3xl bg-white p-8 shadow-sm">
              <h3 className="mb-6 font-sf-pro-rounded text-xl font-semibold text-[#162D3A]">Recent Activity</h3>
                  ...
                  <div className="flex items-center justify-between mb-2">
                    <div className="flex items-center space-x-3">
                      <div className="h-10 w-10 rounded-full bg-[#34C759] flex items-center justify-center">
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path d="M10 18.3333C14.6024 18.3333 18.3334 14.6024 18.3334 10C18.3334 5.39763 14.6024 1.66667 10 1.66667C5.39765 1.66667 1.66669 5.39763 1.66669 10C1.66669 14.6024 5.39765 18.3333 10 18.3333Z" fill="white"/>
                          <path d="M6.66669 10L8.33335 11.6667L13.3334 6.66667" stroke="#34C759" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                        </svg>
                      </div>
                      <div>
                        <p className="font-sf-pro font-medium text-[#162D3A]">Bought 0.025 BTC</p>
                        <p className="font-sf-pro text-sm text-[#8A8A8E]">$918.75 at $36,750.00</p>
                      </div>
                    </div>
                    <span className="font-sf-pro text-sm text-[#8A8A8E]">12:09 PM</span>
                  </div>
                  <p className="font-sf-pro text-sm text-[#8A8A8E] ml-12">Transaction completed successfully</p>
                </div>
                  ...
                  <div className="flex items-center justify-between mb-2">
                    <div className="flex items-center space-x-3">
                      <div className="h-10 w-10 rounded-full bg-[#FF9500] flex items-center justify-center">
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path d="M10 18.3333C14.6024 18.3333 18.3334 14.6024 18.3334 10C18.3334 5.39763 14.6024 1.66667 10 1.66667C5.39765 1.66667 1.66669 5.39763 1.66669 10C1.66669 14.6024 5.39765 18.3333 10 18.3333Z" fill="white"/>
                          <path d="M10 6.66667V10M10 13.3333H10.0083M18.3333 10C18.3333 14.6024 14.6024 18.3333 10 18.3333C5.39763 18.3333 1.66667 14.6024 1.66667 10C1.66667 5.39763 5.39763 1.66667 10 1.66667C14.6024 1.66667 18.3333 5.39763 18.3333 10Z" stroke="#FF9500" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                        </svg>
                      </div>
                      <div>
                        <p className="font-sf-pro font-medium text-[#162D3A]">Alert Set: ETH &lt; $2,300</p>
                        <p className="font-sf-pro text-sm text-[#8A8A8E]">Current price: $2,456.78</p>
                      </div>
                    </div>
                    <span className="font-sf-pro text-sm text-[#8A8A8E]">10:45 AM</span>
                  </div>
                  <p className="font-sf-pro text-sm text-[#8A8A8E] ml-12">Alert will notify you when triggered</p>
                </div>
                  ...
                  <div className="flex items-center justify-between mb-2">
                    <div className="flex items-center space-x-3">
                      <div className="h-10 w-10 rounded-full bg-[#FF3B30] flex items-center justify-center">
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path d="M10 18.3333C14.6024 18.3333 18.3334 14.6024 18.3334 10C18.3334 5.39763 14.6024 1.66667 10 1.66667C5.39765 1.66667 1.66669 5.39763 1.66669 10C1.66669 14.6024 5.39765 18.3333 10 18.3333Z" fill="white"/>
                          <path d="M12.5 7.5L7.5 12.5M7.5 7.5L12.5 12.5" stroke="#FF3B30" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                        </svg>
                      </div>
                      <div>
                        <p className="font-sf-pro font-medium text-[#162D3A]">Sold 0.5 SOL</p>
                        <p className="font-sf-pro text-sm text-[#8A8A8E]">$49.23 at $98.45</p>
                      </div>
                    </div>
                    <span className="font-sf-pro text-sm text-[#8A8A8E]">09:32 AM</span>
                  </div>
                  <p className="font-sf-pro text-sm text-[#8A8A8E] ml-12">Transaction completed successfully</p>
                </div>
              </div>
