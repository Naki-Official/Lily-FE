          ...
          <div className='col-span-2 space-y-8'>
            ...
            <div className='grid grid-cols-1 gap-6 md:grid-cols-3'>
              <div className='rounded-xl bg-white p-6 shadow-sm'>
                <h3 className='font-sf-pro-rounded text-lg font-medium text-[#8A8A8E]'>
                  Total Tokens
                </h3>
                <p className='font-sf-pro-rounded text-3xl font-semibold text-[#162D3A] mt-2'>
                  16
                </p>
              ...
              <div className='rounded-xl bg-white p-6 shadow-sm'>
                ...
                <p className='font-sf-pro-rounded text-3xl font-semibold text-[#34C759] mt-2'>
                  +$823.74
                </p>
                <div className='mt-2 flex items-center text-sm text-[#34C759]'>
                  <svg
                ...
                <table className='w-full'>
                  <thead>
                    <tr className='border-b border-[#E5E5EA]'>
                      <th className='pb-4 text-left font-sf-pro text-sm font-medium text-[#8A8A8E] w-[200px]'>
                        Token
                      </th>
                      <th className='pb-4 text-left font-sf-pro text-sm font-medium text-[#8A8A8E] w-[300px]'>
                        Address
                      </th>
                      ...
                      <th className='pb-4 text-center font-sf-pro text-sm font-medium text-[#8A8A8E]'>
                        Profit/Loss
                      </th>
                    </tr>
                  </thead>
                    ...
                    {[
                      ...
                      return (
                        <tr key={index} className='border-b border-[#F2F2F7]'>
                          ...
                          <td className='py-4 pr-8 font-sf-pro text-sm text-[#8A8A8E]'>
                            {tokenData.address}
                          </td>
                          <td className='py-4 pr-8 font-sf-pro text-[#162D3A]'>
                            {item.received}
                          </td>
                          <td className='py-4 pr-8 font-sf-pro text-[#162D3A]'>
                            {item.spent}
                          ...
                          <td className='py-4 text-center'>
                            <span
                              className={`font-sf-pro font-medium ${item.isProfit ? 'text-[#34C759]' : 'text-[#FF3B30]'}`}
                            >
                              {item.profit}
                            </span>
                          </td>
                ...
                {[
                  ...
                  return (
                    ...
                    >
                      <div className='flex items-center space-x-3'>
                        <TokenIcon symbol={item.token} size={32} />
                        <span className='font-sf-pro text-sm text-[#121212]'>
                          {tokenData.name}
                        </span>
                      </div>
              ...
              <div className='space-y-4'>
                  ...
                  <div className='flex items-center space-x-3'>
                    ...
                    <div>
                      ...
                      <p className='font-sf-pro text-sm text-[#8A8A8E]'>
                        You have a high concentration in AI tokens
                      </p>
                    </div>
                  </div>
                </div>
                <div className='rounded-xl border border-[#E5E5EA] p-4'>
                  <div className='flex items-center space-x-3'>
                    ...
                    <div>
                      <p className='font-sf-pro font-medium text-[#162D3A]'>
                        "Take some profits from AI16Z"
                      </p>
                      <p className='font-sf-pro text-sm text-[#8A8A8E]'>
                        It's up 40% and may be due for correction
                      </p>
                    </div>
                  </div>
                </div>
