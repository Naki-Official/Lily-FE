...
export default function OnboardingPage() {
  ...
  const [selectedGoal, setSelectedGoal] = React.useState<TradingGoal | null>(
    null,
  );
      ...
      <div className='w-full max-w-2xl space-y-8'>
        <div className='space-y-6'>
          ...
          <p className='font-sf-compact text-xl leading-relaxed text-[#313957]'>
            To help our AI recommend the best strategies for you, please select
            your preferred trading goal
          </p>
        </div>
