      ...
      <div className='w-full max-w-2xl space-y-8'>
        <div className='space-y-6'>
          ...
          <p className='font-sf-compact text-xl leading-relaxed text-[#313957]'>
            Based on your chosen risk level, here's a suggested allocation. You
          ...
          <div className='rounded-xl border-2 border-[#D9D9D9] bg-white p-8'>
            <div className='flex items-center justify-between'>
              <div className='flex items-center space-x-4'>
                ...
                <div>
                  <h2 className='font-sf-compact text-3xl font-semibold'>
                    Bitcoin
                  </h2>
              ...
              <div className='font-sf-compact-rounded text-4xl font-semibold'>
                60%
              </div>
            </div>
          </div>
            ...
            <div className='flex items-center justify-between'>
              <div className='flex items-center space-x-4'>
                ...
                <div>
                  ...
                  <p className='mt-2 font-sf-compact-rounded text-sm font-light'>
                    Tracks the performance of Bitcoin & Ethereum via ETF
                    listings
                  </p>
                </div>
              </div>
          ...
          <div className='rounded-xl border-2 border-[#D9D9D9] bg-white p-8'>
            <div className='flex items-center justify-between'>
              <div>
                ...
                <p className='mt-2 font-sf-compact-rounded text-sm font-light'>
                  Tracks the performance of top memecoins by market
                  capitalization.
                </p>
              </div>
              <div className='font-sf-compact-rounded text-4xl font-semibold'>
