...
export default function HomePage() {
  ...
  // Fetch user's SOL balance and wallet address
  ...
  const fetchWalletAddress = React.useCallback(async () => {
    if (!authenticated) return;
    ...
    try {
      ...
      const addressMatch = data.response.match(/address is ([a-zA-Z0-9]{32,44})/i);
  ...
  // Fetch balance and address when component mounts and user is authenticated
  React.useEffect(() => {
    if (authenticated) {
      fetchSolBalance();
      fetchWalletAddress();
    }
  }, [authenticated, fetchSolBalance, fetchWalletAddress]);
        ...
        <div className="mb-8 md:mb-10 flex flex-wrap items-center justify-between gap-4">
          ...
          <div className="flex items-center space-x-3 md:space-x-4">
            {authenticated && (
              <>
                {walletAddress && (
                  <div className="hidden md:flex items-center space-x-3 rounded-full bg-white/10 backdrop-blur-sm px-4 py-2 md:px-5 md:py-2.5 shadow-sm border border-white/20">
                    <div className="h-8 w-8 md:h-9 md:w-9 rounded-full bg-[#E0F2FF] flex items-center justify-center">
                    ...
                    <div className="flex items-center">
                      <span className="font-sf-pro text-sm md:text-base text-white">
                ...
                {solBalance !== null && (
                  <div className="flex items-center space-x-3 rounded-full bg-white/10 backdrop-blur-sm px-4 py-2 md:px-5 md:py-2.5 shadow-sm border border-white/20">
                    <div className="h-8 w-8 md:h-9 md:w-9 rounded-full bg-custom-accent flex items-center justify-center">
                    ...
                    <div className="flex items-center">
                      <span className="font-sf-pro text-sm md:text-base text-white">{solBalance} SOL</span>
                      <button 
            ...
            {authenticated && (
              <button 
                ...
                className="flex items-center space-x-2 rounded-full px-4 py-2 md:px-5 md:py-2.5 text-white bg-[rgba(255,59,48,0.2)] hover:bg-[rgba(255,59,48,0.3)] transition-colors border border-[rgba(255,59,48,0.3)]"
              >
                <span className="font-sf-pro text-sm md:text-base">Log out</span>
              </button>
            )}
              ...
              <div className="rounded-2xl md:rounded-3xl bg-white p-4 md:p-6 lg:p-8 shadow-md hover:shadow-lg transition-shadow">
                ...
                <form onSubmit={handleSubmit} className="relative">
                  <input
                    ...
                    className="w-full rounded-full border border-[#E5E5EA] bg-[#F9F9F9] px-4 py-3 md:px-6 md:py-4 pr-12 md:pr-16 text-sm md:text-base text-[#162D3A] focus:outline-none focus:ring-2 focus:ring-[#007AFF] focus:border-transparent"
                    disabled={isLoading}
                  />
                  <button
                    type="submit"
              ...
              <div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 md:gap-6">
                  ...
                  {[
                    ...
                    <div key={index} className="rounded-xl md:rounded-2xl bg-white/90 backdrop-blur-sm p-4 md:p-6 shadow-sm hover:shadow-lg hover:scale-105 transition-all duration-300">
                      <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-3 md:space-x-4">
                          <div className="h-10 w-10 md:h-12 md:w-12 rounded-full bg-[#F2F2F7] flex items-center justify-center">
